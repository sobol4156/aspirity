      ...
      <body className={inter.className}>
        <header className="flex justify-between p-5">
          ...
          <div className="flex items-center gap-2">
            <button className="h-10 bg-[#0047BB] px-4 rounded hidden md:block">СОЗДАТЬ СЧЁТ</button>
            <button className="h-10 bg-[#0047BB] px-4 rounded hidden md:block">КОРЗИНА</button>
